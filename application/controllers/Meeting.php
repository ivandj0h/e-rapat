...
class Meeting extends CI_Controller
{
    ...
    public function store_meeting()
    {
        ...
        if ($this->form_validation->run()) {
            ...
            $array = array(
                'success' => '<div class="popup-wrapper" id="popup"><div class="popup-container"><h2 class="text-danger">Mohon Menunggu,</h2><p class="text-danger">System Sedang membuat Rapat untuk anda... <img src="http://localhost/rapat/assets/img/ajax-loader.gif">',
            );
        } else {
            $array = array(
                'error'   => true,
