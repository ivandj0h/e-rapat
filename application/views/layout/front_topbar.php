<body>
    <div class="d-flex flex-column flex-md-row align-items-center p-3 px-md-4 shadow-sm fixed-top">
        <h5 class="my-0 mr-md-auto font-weight-normal"><img src="<?= base_url('assets/img/transport.svg'); ?>" alt="" style="width:50px"> BADAN PENELITIAN DAN PENGEMBANGAN KEMENTRIAN PERHUBUNGAN</h5>
